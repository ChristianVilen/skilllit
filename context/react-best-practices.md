...
1. [Eliminating Waterfalls](#1-eliminating-waterfalls) — **CRITICAL**
   ...
   - 1.3 [Prevent Waterfall Chains in API Endpoints](#13-prevent-waterfall-chains-in-api-endpoints)
...
3. [Server-Side Performance](#3-server-side-performance) — **HIGH**
   ...
   - 3.2 [Minimize Data Transfer to Client](#32-minimize-data-transfer-to-client)
...
### 1.3 Prevent Waterfall Chains in API Endpoints

**Impact: CRITICAL (2-10× improvement)**

In API endpoints and server handlers, start independent operations immediately, even if you don't await them yet.
